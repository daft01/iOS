...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Firebasechat",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12Firebasechat11AppDelegate")
...
SWIFT_CLASS("_TtC12Firebasechat18HomeViewController")
...
- (void)viewDidLoad;
- (IBAction)readAction:(id _Nonnull)sender;
- (IBAction)postAction:(id _Nonnull)sender;
...
SWIFT_CLASS("_TtC12Firebasechat19ImageViewController")
@interface ImageViewController : UIViewController <UIImagePickerControllerDelegate, UINavigationControllerDelegate>
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified imageDownload;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified imagePreview;
- (void)viewDidLoad;
- (IBAction)imageSelect:(id _Nonnull)sender;
- (IBAction)imageUpload:(id _Nonnull)sender;
- (IBAction)imageDownload:(id _Nonnull)sender;
- (IBAction)clearImage:(id _Nonnull)sender;
...
SWIFT_CLASS("_TtC12Firebasechat13SceneDelegate")
...
SWIFT_CLASS("_TtC12Firebasechat10SignInView")
...
SWIFT_CLASS("_TtC12Firebasechat10SignUpView")
